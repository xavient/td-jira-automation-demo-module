...
public class dmo1 {
    ...
    public void setup() throws IOException {
    	Reporting.log(Status.INFO,"Setting up test resources...");
        ...
        Reporting.log(Status.INFO, "Test resources created successfully.");
    }
    ...
    public void testCreateJiraIssue_withAttachment() {
       ...
       // File dummyFile = new File(DUMMY_IMAGE_PATH);
        ...
        Reporting.log(Status.PASS, "Successfully created Jira issue with key: " + issueKey);
    ...
    public void testSearchOpenIssues_returnsStandardDetails() {
        ...
        Reporting.log(Status.PASS,"JIRA search completed: {} total issues, {} returned"+
                results.total);
    
        for (Issue issue : results.issues) {
        	 Reporting.log(Status.PASS,"Issue: {} | Summary: {} | Status: {} | Assignee: {}"+" "+ 
                        issue.getKey()+" "+
                        issue.getSummary()+" "+
